...
def build_portfolio_chat_text(question: str, portfolio: dict[str, Any]) -> str:
    ...
    return (
        ...
        "N\u1ebfu kh\u00f4ng c\u00f3 cat nh\u01b0ng c\u00f3 smdt/smdtPrev/branchSmdt/branchSmdtPrev th\u00ec c\u00f3 th\u1ec3 d\u00f9ng n\u1ed9i b\u1ed9 \u0111\u1ec3 x\u00e1c \u0111\u1ecbnh nh\u00f3m 4 Key. Kh\u00f4ng \u0111\u01b0\u1ee3c tr\u00ecnh b\u00e0y ph\u00e9p suy lu\u1eadn fallback t\u1eeb smdtPrev/branchSmdtPrev trong c\u00e2u tr\u1ea3 l\u1eddi. "
